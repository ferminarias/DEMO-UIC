...
class VoiceWidgetCore {
      ...
      const conversation = await Conversation.startSession({
        ...
        onError: (error) => {
          ...
          try {
            ...
            console.error("[VoiceWidget] Error while forcing session end after onError:", e2);
          }
          if (this.refs.mediaStream) {
            this.refs.mediaStream.getTracks().forEach((track) => track.stop());
            this.refs.mediaStream = null;
  ...
  safeEndSession() {
    ...
    try {
      ...
      console.error("[VoiceWidget] Error ending ElevenLabs session:", e2);
    }
  }
  toggleMute() {
    var _a;
  ...
  async initialize() {
    ...
    try {
      await Promise.race([
        ...
        new Promise(
          (_3, reject) => setTimeout(() => reject(new Error("Config check timeout")), 1e4)
        )
      ]);
    } catch (error) {
...
class VoiceWidgetUI {
  ...
  attachEventListeners() {
    ...
    if (this.elements.textField) {
      this.elements.textField.addEventListener("keypress", (e2) => {
        if (e2.key === "Enter") {
          this.handleTextSubmit();
        }
      });
      this.elements.textField.addEventListener("input", () => {
        var _a, _b;
        if ((_b = (_a = this.voiceWidget.refs.session) == null ? void 0 : _a.conversation) == null ? void 0 : _b.sendUserActivity) {
...
var h$1 = (i2, s2, t) => s2 in i2 ? e(i2, s2, {
  enumerable: true,
  configurable: true,
  writable: true,
  value: t
}) : i2[s2] = t;
var o = (i2, s2, t) => h$1(i2, typeof s2 != "symbol" ? s2 + "" : s2, t);
let _$1 = class _ {
  constructor() {
    o(this, "_locking");
    o(this, "_locks");
    ...
    equals(type, a, b2) {
      ...
      return type.fields.byMember().every((m2) => {
        ...
        if (m2.repeated) {
          ...
          switch (m2.kind) {
            case "message":
              return va.every((a2, i2) => m2.T.equals(a2, vb[i2]));
            case "scalar":
              return va.every((a2, i2) => scalarEquals(m2.T, a2, vb[i2]));
            case "enum":
              return va.every((a2, i2) => scalarEquals(ScalarType.INT32, a2, vb[i2]));
          }
          ...
          case "message":
            ...
            if (m2.T.fieldWrapper) {
              if (a2 !== void 0 && !isMessage(a2)) {
                a2 = m2.T.fieldWrapper.wrapField(a2);
              }
              if (b22 !== void 0 && !isMessage(b22)) {
                b22 = m2.T.fieldWrapper.wrapField(b22);
              }
            }
            return m2.T.equals(a2, b22);
          case "enum":
...
function areDimensionsSmaller(a, b2) {
  return a.width * a.height < b2.width * b2.height;
}
...
class E2EEManager extends eventsExports.EventEmitter {
  ...
  setupEventListeners(room, keyProvider) {
    ...
    }).on(RoomEvent.TrackUnsubscribed, (track, _22, participant) => {
      var _a;
      const msg = {
...
function r$1(r2, e2, n) {
  var i2, t, o2;
  void 0 === e2 && (e2 = 50), void 0 === n && (n = {});
  var a = null != (i2 = n.isImmediate) && i2, u2 = null != (t = n.callback) && t, c2 = n.maxWait, v2 = Date.now(), l2 = [];
  function f2() {
    if (void 0 !== c2) {
      var r3 = Date.now() - v2;
  ...
  var d2 = function() {
    ...
    return new Promise(function(i22, t2) {
      var c22 = a && void 0 === o2;
...
class CloudRegionCheck extends Checker {
  ...
  perform() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      regionStats.sort((a, b2) => {
        return (a.duration - b2.duration) * 0.5 + (a.rtt - b2.rtt) * 0.5;
      });
...
class r {
  ...
  handleAgentResponse(e2) {
    this.options.onMessage && this.options.onMessage({ source: "ai", message: e2.agent_response_event.agent_response });
  }
  handleUserTranscript(e2) {
    this.options.onMessage && this.options.onMessage({ source: "user", message: e2.user_transcription_event.user_transcript });
  }
  ...
  handleAgentToolResponse(e2) {
    this.options.onAgentToolResponse && this.options.onAgentToolResponse(e2.agent_tool_response);
  }
...
function p(e2) {
  ...
  const n = { type: h };
  var o2, a, s2, i2, r2;
  return e2.overrides && (n.conversation_config_override = { agent: { prompt: null == (o2 = e2.overrides.agent) ? void 0 : o2.prompt, first_message: null == (a = e2.overrides.agent) ? void 0 : a.firstMessage, language: null == (s2 = e2.overrides.agent) ? void 0 : s2.language }, tts: { voice_id: null == (i2 = e2.overrides.tts) ? void 0 : i2.voiceId }, conversation: { text_only: null == (r2 = e2.overrides.conversation) ? void 0 : r2.textOnly } }), e2.customLlmExtraBody && (n.custom_llm_extra_body = e2.customLlmExtraBody), e2.dynamicVariables && (n.dynamic_variables = e2.dynamicVariables), e2.userId && (n.user_id = e2.userId), null != (t = e2.overrides) && t.client && (n.source_info = { source: e2.overrides.client.source, version: e2.overrides.client.version }), n;
}
class m extends c {
  ...
  static async create(e2) {
    ...
    try {
      var n, o2, a;
      const s3 = null != (n = e2.origin) ? n : "wss://api.elevenlabs.io";
      let i2;
      const r2 = (null == (o2 = e2.overrides) || null == (o2 = o2.client) ? void 0 : o2.version) || u, c2 = (null == (a = e2.overrides) || null == (a = a.client) ? void 0 : a.source) || "js_sdk";
      if (e2.signedUrl) {
        const t2 = e2.signedUrl.includes("?") ? "&" : "?";
        i2 = `${e2.signedUrl}${t2}source=${c2}&version=${r2}`;
      } else i2 = `${s3}/v1/convai/conversation?agent_id=${e2.agentId}&source=${c2}&version=${r2}`;
      const h2 = ["convai"];
      e2.authorization && h2.push(`bearer.${e2.authorization}`), t = new WebSocket(i2, h2);
      ...
      }), { conversation_id: g2, agent_output_audio_format: f2, user_input_audio_format: w2 } = v2, y2 = l(null != w2 ? w2 : "pcm_16000"), _3 = l(f2);
      return new m(t, g2, y2, _3);
    } catch (e3) {
      var s2;
      throw null == (s2 = t) || s2.close(), e3;
    }
  }
  close() {
    this.socket.close();
...
class _2 extends c {
  ...
  static async create(n) {
    ...
    if ("conversationToken" in n && n.conversationToken) o2 = n.conversationToken;
      ...
      try {
        var a, s2, i2;
        const e2 = (null == (a = n.overrides) || null == (a = a.client) ? void 0 : a.version) || u, t = (null == (s2 = n.overrides) || null == (s2 = s2.client) ? void 0 : s2.source) || "js_sdk", c3 = `${r2 = null != (i2 = n.origin) ? i2 : "https://api.elevenlabs.io", r2.replace(/^wss:\/\//, "https://")}/v1/convai/conversation/token?agent_id=${n.agentId}&source=${t}&version=${e2}`, l2 = await fetch(c3);
    ...
    const c2 = new Room();
    try {
      const e2 = `room_${Date.now()}`, a2 = l("pcm_48000"), s3 = l("pcm_48000"), i3 = new _2(c2, e2, a2, s3, n), r3 = n.livekitUrl || "wss://livekit.rtc.elevenlabs.io";
      var d2;
      await c2.connect(r3, o2), await new Promise((e3) => {
      ...
      const u2 = p(n);
      return i3.debug({ type: h, message: u2 }), await i3.sendMessage(u2), i3;
    } catch (e2) {
  ...
  setupRoomEventListeners() {
    ...
    }), this.room.on(RoomEvent.TrackSubscribed, async function(t, n, a) {
      if (t.kind === Track.Kind.Audio && a.identity.includes("agent")) {
  ...
  async setupAudioCapture(e2) {
    try {
      ...
      o2.connect(this.outputAnalyser), await y(t.audioWorklet);
      const a = new AudioWorkletNode(t, "rawAudioProcessor");
      this.outputAnalyser.connect(a), a.port.postMessage({ type: "setFormat", format: this.outputFormat.format, sampleRate: this.outputFormat.sampleRate }), a.port.onmessage = (e3) => {
        const [t2, n2] = e3.data;
        if (n2 > 0.01) {
  ...
  async setAudioInputDevice(e2) {
    ...
    try {
      ...
      const n = { deviceId: { exact: e2 }, echoCancellation: true, noiseSuppression: true, autoGainControl: true, channelCount: { ideal: 1 } }, s2 = await createLocalAudioTrack(n);
      await this.room.localParticipant.publishTrack(s2, { name: "microphone", source: Track.Source.Microphone });
    } catch (e3) {
...
async function C(e2 = { default: 0, android: 3e3 }) {
  let t = e2.default;
  var n;
...
class S extends r {
  static async startSession(e2) {
    ...
    let n = null;
    try {
      return await C(t.connectionDelay), n = await k(e2), new S(t, n);
    } catch (e3) {
      var o2;
...
const M = { echoCancellation: true, noiseSuppression: true, autoGainControl: true, channelCount: { ideal: 1 } };
class I {
  static async create({ sampleRate: e2, format: t, preferHeadphonesForIosDevices: n, inputDeviceId: o2, workletPaths: a, libsampleratePath: i2 }) {
    let r2 = null, c2 = null;
    try {
      const l3 = s({ sampleRate: { ideal: e2 } }, M);
      if (b() && n) {
      ...
      o2 && (l3.deviceId = { exact: o2 });
      const u3 = navigator.mediaDevices.getSupportedConstraints().sampleRate;
      r2 = new window.AudioContext(u3 ? { sampleRate: e2 } : {});
      const d2 = r2.createAnalyser();
      if (!u3) {
        const e3 = i2 || "https://cdn.jsdelivr.net/npm/@alexanderolsen/libsamplerate-js@2.1.2/dist/libsamplerate.worklet.js";
        await r2.audioWorklet.addModule(e3);
      }
      await y(r2.audioWorklet, null == a ? void 0 : a.rawAudioProcessor);
      const h2 = s({ voiceIsolation: true }, l3);
      c2 = await navigator.mediaDevices.getUserMedia({ audio: h2 });
      const p2 = r2.createMediaStreamSource(c2), m2 = new AudioWorkletNode(r2, "rawAudioProcessor");
      return m2.port.postMessage({ type: "setFormat", format: t, sampleRate: e2 }), p2.connect(d2), d2.connect(m2), await r2.resume(), new I(r2, d2, m2, c2, p2);
    } catch (e3) {
      var l2, u2;
      throw null == (l2 = c2) || l2.getTracks().forEach((e4) => {
        e4.stop();
      }), null == (u2 = r2) || u2.close(), e3;
    }
  }
  constructor(e2, t, n, o2, a) {
    this.context = void 0, this.analyser = void 0, this.worklet = void 0, this.inputStream = void 0, this.mediaStreamSource = void 0, this.context = e2, this.analyser = t, this.worklet = n, this.inputStream = o2, this.mediaStreamSource = a;
  }
  async close() {
  ...
  async setInputDevice(e2) {
    try {
      const t = s({}, M);
      e2 && (t.deviceId = { exact: e2 });
      const n = s({ voiceIsolation: true }, t), o2 = await navigator.mediaDevices.getUserMedia({ audio: n });
...
const D = w("audioConcatProcessor", '/*\n * ulaw decoding logic taken from the wavefile library\n * https://github.com/rochars/wavefile/blob/master/lib/codecs/mulaw.js\n * USED BY @elevenlabs/client\n */\n\nconst decodeTable = [0,132,396,924,1980,4092,8316,16764];\n\nfunction decodeSample(muLawSample) {\n  let sign;\n  let exponent;\n  let mantissa;\n  let sample;\n  muLawSample = ~muLawSample;\n  sign = (muLawSample & 0x80);\n  exponent = (muLawSample >> 4) & 0x07;\n  mantissa = muLawSample & 0x0F;\n  sample = decodeTable[exponent] + (mantissa << (exponent+3));\n  if (sign !== 0) sample = -sample;\n\n  return sample;\n}\n\nclass AudioConcatProcessor extends AudioWorkletProcessor {\n  constructor() {\n    super();\n    this.buffers = []; // Initialize an empty buffer\n    this.cursor = 0;\n    this.currentBuffer = null;\n    this.wasInterrupted = false;\n    this.finished = false;\n    \n    this.port.onmessage = ({ data }) => {\n      switch (data.type) {\n        case "setFormat":\n          this.format = data.format;\n          break;\n        case "buffer":\n          this.wasInterrupted = false;\n          this.buffers.push(\n            this.format === "ulaw"\n              ? new Uint8Array(data.buffer)\n              : new Int16Array(data.buffer)\n          );\n          break;\n        case "interrupt":\n          this.wasInterrupted = true;\n          break;\n        case "clearInterrupted":\n          if (this.wasInterrupted) {\n            this.wasInterrupted = false;\n            this.buffers = [];\n            this.currentBuffer = null;\n          }\n      }\n    };\n  }\n  process(_, outputs) {\n    let finished = false;\n    const output = outputs[0][0];\n    for (let i = 0; i < output.length; i++) {\n      if (!this.currentBuffer) {\n        if (this.buffers.length === 0) {\n          finished = true;\n          break;\n        }\n        this.currentBuffer = this.buffers.shift();\n        this.cursor = 0;\n      }\n\n      let value = this.currentBuffer[this.cursor];\n      if (this.format === "ulaw") {\n        value = decodeSample(value);\n      }\n      output[i] = value / 32768;\n      this.cursor++;\n\n      if (this.cursor >= this.currentBuffer.length) {\n        this.currentBuffer = null;\n      }\n    }\n\n    if (this.finished !== finished) {\n      this.finished = finished;\n      this.port.postMessage({ type: "process", finished });\n    }\n\n    return true; // Continue processing\n  }\n}\n\nregisterProcessor("audioConcatProcessor", AudioConcatProcessor);\n');
class F {
  static async create({ sampleRate: e2, format: t, outputDeviceId: n, workletPaths: o2 }) {
    let a = null, s2 = null;
    try {
      a = new AudioContext({ sampleRate: e2 });
      const i3 = a.createAnalyser(), r3 = a.createGain();
      s2 = new Audio(), s2.src = "", s2.load(), s2.autoplay = true, s2.style.display = "none", document.body.appendChild(s2);
      const c2 = a.createMediaStreamDestination();
      s2.srcObject = c2.stream, r3.connect(i3), i3.connect(c2), await D(a.audioWorklet, null == o2 ? void 0 : o2.audioConcatProcessor);
      const l2 = new AudioWorkletNode(a, "audioConcatProcessor");
      return l2.port.postMessage({ type: "setFormat", format: t }), l2.connect(r3), await a.resume(), n && s2.setSinkId && await s2.setSinkId(n), new F(a, i3, r3, l2, s2);
    } catch (e3) {
      var i2, r2;
      throw null != (i2 = s2) && i2.parentNode && s2.parentNode.removeChild(s2), null == (r2 = s2) || r2.pause(), a && "closed" !== a.state && await a.close(), e3;
    }
  }
  constructor(e2, t, n, o2, a) {
    this.context = void 0, this.analyser = void 0, this.gain = void 0, this.worklet = void 0, this.audioElement = void 0, this.context = e2, this.analyser = t, this.gain = n, this.worklet = o2, this.audioElement = a;
  }
...
class A extends r {
  static async startSession(e2) {
    ...
    let o2 = null, a = null, i2 = null, c2 = null, l2 = null;
    ...
    try {
      var u2;
      return c2 = await navigator.mediaDevices.getUserMedia({ audio: true }), await C(n.connectionDelay), a = await k(e2), [o2, i2] = await Promise.all([I.create(s({}, a.inputFormat, { preferHeadphonesForIosDevices: e2.preferHeadphonesForIosDevices, inputDeviceId: e2.inputDeviceId, workletPaths: e2.workletPaths, libsampleratePath: e2.libsampleratePath })), F.create(s({}, a.outputFormat, { outputDeviceId: e2.outputDeviceId, workletPaths: e2.workletPaths }))]), null == (u2 = c2) || u2.getTracks().forEach((e3) => {
        e3.stop();
      }), c2 = null, new A(n, a, o2, i2, l2);
    } catch (e3) {
      var d2, h2, p2, m2;
      n.onStatusChange && n.onStatusChange({ status: "disconnected" }), null == (d2 = c2) || d2.getTracks().forEach((e4) => {
        e4.stop();
      }), null == (h2 = a) || h2.close(), await (null == (p2 = o2) ? void 0 : p2.close()), await (null == (m2 = i2) ? void 0 : m2.close());
      try {
        var v2;
  ...
  constructor(e2, t, n, o2, a) {
    super(e2, t), this.input = void 0, this.output = void 0, this.wakeLock = void 0, this.inputFrequencyData = void 0, this.outputFrequencyData = void 0, this.onInputWorkletMessage = (e3) => {
      ...
      this.output.gain.gain.value = this.volume, this.output.worklet.port.postMessage({ type: "clearInterrupted" }), this.output.worklet.port.postMessage({ type: "buffer", buffer: g(e3) });
    }, this.fadeOutAudio = () => {
      ...
      this.volume = t2, this.connection instanceof _2 ? this.connection.setAudioVolume(t2) : this.output.gain.gain.value = t2;
    }, this.input = n, this.output = o2, this.wakeLock = a, this.input.worklet.port.onmessage = this.onInputWorkletMessage, this.output.worklet.port.onmessage = this.onOutputWorkletMessage;
  }
  async handleEndSession() {
  ...
  handleAudio(e2) {
    var t, n;
    this.lastInterruptTimestamp <= e2.audio_event.event_id && (null == (t = (n = this.options).onAudio) || t.call(n, e2.audio_event.audio_base_64), this.connection instanceof _2 || this.addAudioBase64Chunk(e2.audio_event.audio_base_64), this.currentEventId = e2.audio_event.event_id, this.updateCanSendFeedback(), this.updateMode("speaking"));
  }
  setMicMuted(e2) {
    this.connection instanceof _2 ? this.connection.setMicMuted(e2) : this.input.setMuted(e2);
  }
  getInputByteFrequencyData() {
  ...
  getOutputByteFrequencyData() {
    return this.connection instanceof _2 ? this.connection.getOutputByteFrequencyData() || new Uint8Array(1024) : (null != this.outputFrequencyData || (this.outputFrequencyData = new Uint8Array(this.output.analyser.frequencyBinCount)), this.output.analyser.getByteFrequencyData(this.outputFrequencyData), this.outputFrequencyData);
  }
  getInputVolume() {
  ...
  async changeInputDevice({ sampleRate: e2, format: t, preferHeadphonesForIosDevices: n, inputDeviceId: o2 }) {
    try {
      ...
      this.connection instanceof _2 && await this.connection.setAudioInputDevice(o2 || ""), await this.input.close();
      const a = await I.create({ sampleRate: null != e2 ? e2 : this.connection.inputFormat.sampleRate, format: null != t ? t : this.connection.inputFormat.format, preferHeadphonesForIosDevices: n, inputDeviceId: o2, workletPaths: this.options.workletPaths, libsampleratePath: this.options.libsampleratePath });
      return this.input = a, this.input.worklet.port.onmessage = this.onInputWorkletMessage, this.input;
    } catch (e3) {
  ...
  async changeOutputDevice({ sampleRate: e2, format: t, outputDeviceId: n }) {
    try {
      ...
      this.connection instanceof _2 && await this.connection.setAudioOutputDevice(n || ""), await this.output.close();
      const o2 = await F.create({ sampleRate: null != e2 ? e2 : this.connection.outputFormat.sampleRate, format: null != t ? t : this.connection.outputFormat.format, outputDeviceId: n, workletPaths: this.options.workletPaths });
