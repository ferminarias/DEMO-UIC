...
const UTMTracker = (function() {
    ...
    /**
     * Completa formularios con los valores de las cookies UTM
     * @param {string} formId - ID del formulario a completar
     */
    function fillFormWithCookies(formId) {
        // Obtener todos los formularios que coincidan con el ID
        ...
        console.log(`UTMTracker: Encontrados ${forms.length} formularios con ID "${formId}"`);
        
        const utmParams = Object.values(UTM_PARAMS);
        
        // Iterar sobre cada formulario encontrado
        forms.forEach((form, index) => {
            console.log(`UTMTracker: Rellenando formulario #${index + 1} con ID "${formId}"`);
...
// Ejemplo de uso con múltiples formularios:
// document.addEventListener('DOMContentLoaded', function() {
//     // Inicializa el rastreador UTM para todos los formularios con ID 'WebToLeadForm'
//     // Esto rellenará automáticamente todos los formularios que tengan este ID
//     UTMTracker.initialize('WebToLeadForm');
// });